...
namespace Lab_1 {
    class Input {
        public static int IntInput() {
            ...
            do {
                ...
                if (!isConvert) {
                    Console.Write("Строку невозможно преобразовать, введите новое значение: ");
                }
            } while (!isConvert);
            return number;
        }
    ...
    internal class Program {
        ...
        public static void CompleteThirdTask() {
            ...
            float floatResult = (float)(floatTemp1 - floatTemp2) / floatTemp3;
            Console.WriteLine("\n((a-b)^2 - (a^2 + 2ab)) / b^2\na = 1000, b = 0.0001");
            ...
            double doubleResult = (double)(doubleTemp1 - doubleTemp2) / doubleTemp3;
