...
SELECT lastname AS "Фамилия", adress AS "Адрес"
FROM table_прядеин ORDER BY adress;

SELECT lastname AS "Фамилия", employment_day AS "Дата устройства",
TIMESTAMPDIFF(YEAR, employment_day, CURRENT_DATE()) as 'Опыт работы'
FROM table_прядеин
